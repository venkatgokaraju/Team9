...
public class TestPacManValidMoves extends TestCase {
	...
	public void testPacManValidMoves() throws FileNotFoundException{
		...
		public static boolean test1Setup() throws Exception {
			...
			return pacman.get_valid_moves().size()==0;
		}
		public static boolean test2Setup() throws Exception {
			...
			return pacman.get_valid_moves().size()==1 && 
			pacman.get_valid_moves().contains(new Location(11,11));
		}
		public static boolean test3Setup() throws Exception {
			...
			return pacman.get_valid_moves().size()==2 && 
			pacman.get_valid_moves().contains(new Location(10,11)) &&
			pacman.get_valid_moves().contains(new Location(11,11));
		}
		public static boolean test4Setup() throws Exception {
			...
			return pacman.get_valid_moves().size()==3 && 
			pacman.get_valid_moves().contains(new Location( 9,11)) &&
			pacman.get_valid_moves().contains(new Location(10,11)) &&
			pacman.get_valid_moves().contains(new Location(11,11));
		}
		public static boolean test5Setup() throws Exception {
			...
			return pacman.get_valid_moves().size()==3 && 
			pacman.get_valid_moves().contains(new Location(11,10)) && // this clause fails
			pacman.get_valid_moves().contains(new Location( 9,11)) &&
			pacman.get_valid_moves().contains(new Location(10,11)) &&
			pacman.get_valid_moves().contains(new Location(11,11));
		}
